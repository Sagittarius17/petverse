...
export const allCareGuides: CareGuide[] = [
    { id: 'cg1', title: 'Beginner\'s Guide to Dog Care', petType: 'Dogs', summary: 'Learn the basics of feeding, grooming, and training your new dog.', imageId: 'guide-dog' },
    { id: 'cg2', title: 'Keeping Your Cat Happy Indoors', petType: 'Cats', summary: 'Tips and tricks for enriching your indoor cat\'s life.', imageId: 'guide-cat' },
    { id: 'cg3', title: 'Choosing the Right Cage for Your Bird', petType: 'Birds', summary: 'Size, material, and placement are key for your bird\'s home.', imageId: 'guide-bird' },
    { id: 'cg4', title: 'Aquarium 101: Setting Up Your First Tank', petType: 'Fish', summary: 'A step-by-step guide to creating a healthy environment for your fish.', imageId: 'guide-fish' },
    { id: 'cg5', title: 'Nutrition for a Healthy Dog Coat', petType: 'Dogs', summary: 'Discover the best foods for a shiny, healthy coat.', imageId: 'dog-1' },
    { id: 'cg6', title: 'Understanding Cat Behavior', petType: 'Cats', summary: 'Decode your cat\'s body language and vocalizations.', imageId: 'cat-1' },
];
